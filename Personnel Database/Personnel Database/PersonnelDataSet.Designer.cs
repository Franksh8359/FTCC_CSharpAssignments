...
namespace Personnel_Database {
    ...
    public partial class PersonnelDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonnelDataTable : global::System.Data.TypedTableBase<PersonnelRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonnelRow AddPersonnelRow(string Name, string Position, decimal HourlyPayRate) {
        ...
        public partial class PersonnelRow : global::System.Data.DataRow {
            ...
            public decimal HourlyPayRate {
                get {
                    return ((decimal)(this[this.tablePersonnel.HourlyPayRateColumn]));
                }
                set {
                    this[this.tablePersonnel.HourlyPayRateColumn] = value;
                }
            }
        }
...
namespace Personnel_Database.PersonnelDataSetTableAdapters {
    ...
    public partial class PersonnelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Personnel] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Personnel] ([Name], [Position], [HourlyPayRate]) VALUES (@Name" +
                ", @Position, @HourlyPayRate);\r\nSELECT EmployeeID, Name, Position, HourlyPayRate " +
                "FROM Personnel WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Personnel] SET [Name] = @Name, [Position] = @Position, [HourlyPayRate] = @HourlyPayRate WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([HourlyPayRate] = @Original_HourlyPayRate));
SELECT EmployeeID, Name, Position, HourlyPayRate FROM Personnel WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Personnel_Database.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Name, Position, HourlyPayRate FROM dbo.Personnel";
        ...
        public virtual int Fill(PersonnelDataSet.PersonnelDataTable dataTable) {
        ...
        public virtual PersonnelDataSet.PersonnelDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PersonnelDataSet.PersonnelDataTable dataTable = new PersonnelDataSet.PersonnelDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PersonnelDataSet.PersonnelDataTable dataTable) {
